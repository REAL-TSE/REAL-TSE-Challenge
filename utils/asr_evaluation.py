...
def construct_predicted_path_mapping(predicted_dir, chinese_asr_model, english_asr_model):
    ...
    for dataset in datasets:
        ...
        elif dataset in ["AMI", "CHiME6", "DipCo"]:
...
def main(args):
    ...
    print("Evaluating...\n")
    evaluation_df = evaluate_TER(args.ground_truth_dir, predicted_path_mapping)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--predicted_dir", type=str, required=True, help="Directory containing predicted results.")
    parser.add_argument("--chinese_asr_model", type=str, default="zipformer-zh", help="ASR model name for Chinese datasets.")
    parser.add_argument("--english_asr_model", type=str, default="zipformer-en", help="ASR model name for English datasets.")
