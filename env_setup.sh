...
if [ -d "${REAL_T_ROOT}/FireRedASR2S" ]; then
    export PATH="${REAL_T_ROOT}/FireRedASR2S${PATH:+:$PATH}"
fi

for local_repo in "${REAL_T_ROOT}/FireRedASR2S" "${REAL_T_ROOT}/wesep_real_tse"; do
